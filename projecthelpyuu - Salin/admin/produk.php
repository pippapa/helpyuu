...
<a href="<?php echo "?p=produkadd"; ?>"><button type="button" class="btn btn-add">Tambah Jasa</button></a>
<br>
<?php
$batas = 4;
$halaman = $_GET["pg"];
...
while($rp = mysqli_fetch_array($sqlp)){
    ...
    echo "<br><a href='?p=produkdetail&id=$rp[idproduk]'><button type='button' class='btn btn-add'>Detail</button></a>
          <a href='?p=produkedit&id=$rp[idproduk]'><button type='button' class='btn btn-add'>Edit Jasa</button>
...
echo "Total Jasa Dan Layanan <span class='kotak'><b>$jmldata</b></span>";
echo "<p></div>";
echo "<p>&nbsp;</p>";
?>